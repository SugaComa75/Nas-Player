...
$configFile = $siteRoot . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'music-local.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$installed) {
    ...
    try {
        ...
        if (file_put_contents($temporary, $config, LOCK_EX) === false || !rename($temporary, $configFile)) {
            throw new RuntimeException('The installer could not write the private music configuration. Check the data folder permissions.');
        }
